...
public abstract class BaseRules implements Rules {
    ...
    public boolean generateDeleteByExample() {
    	if(introspectedTable.getContext().getJavaModelGeneratorConfiguration().getProperty("generateExample")==null 
    			||introspectedTable.getContext().getJavaModelGeneratorConfiguration().getProperty("generateExample").equalsIgnoreCase("false")){
    		 // if generateExample is null or empty - don't generate the example class
    	   return false;	
    	}
