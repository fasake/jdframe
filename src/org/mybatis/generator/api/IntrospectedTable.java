...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_SELECT_BY_NON_PRIMARY_KEY_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        String table_name = tableConfiguration.getTableName()+"#";
        
        setCountByExampleStatementId(table_name+"countByExample"); //$NON-NLS-1$
        setDeleteByExampleStatementId(table_name+"deleteByExample"); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId(table_name+"deleteByPrimaryKey"); //$NON-NLS-1$
        
        setInsertStatementId(table_name+"_insert"); //$NON-NLS-1$
        setInsertSelectiveStatementId(table_name+"insertSelective"); //$NON-NLS-1$
        setSelectAllStatementId(table_name+"selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId(table_name+"selectByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId(table_name+"selectByExampleWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId(table_name+"selectByPrimaryKey"); //$NON-NLS-1$
        
        setSelectByNoNPrimaryKeyStatementId(table_name+"selectByNoNPrimaryKey_listPage"); //$NON-NLS-1$
        setUpdateByExampleStatementId(table_name+"updateByExample"); //$NON-NLS-1$
        setUpdateByExampleSelectiveStatementId(table_name+"updateByExampleSelective"); //$NON-NLS-1$
        setUpdateByExampleWithBLOBsStatementId(table_name+"updateByExampleWithBLOBs"); //$NON-NLS-1$
        setUpdateByPrimaryKeyStatementId(table_name+"updateByPrimaryKey"); //$NON-NLS-1$
        setUpdateByPrimaryKeySelectiveStatementId(table_name+"updateByPrimaryKeySelective"); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId(table_name+"updateByPrimaryKeyWithBLOBs"); //$NON-NLS-1$
        setBaseResultMapId(table_name+"BaseResultMap"); //$NON-NLS-1$
        setResultMapWithBLOBsId(table_name+"ResultMapWithBLOBs"); //$NON-NLS-1$
        setExampleWhereClauseId(table_name+"Example_Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId(table_name+"Base_Column_List"); //$NON-NLS-1$
        setBlobColumnListId(table_name+"Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId(table_name+"Update_By_Example_Where_Clause"); //$NON-NLS-1$
    }
    ...
    public void setSelectByNoNPrimaryKeyStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_NON_PRIMARY_KEY_STATEMENT_ID, s);
    }
    ...
    public String getSelectByNoNPrimaryKeyStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_NON_PRIMARY_KEY_STATEMENT_ID);
    }
