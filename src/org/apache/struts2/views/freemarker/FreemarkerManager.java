...
//            config = createConfiguration(servletContext);
    ...
    protected ScopesHashModel buildScopesHashModel(ServletContext servletContext, HttpServletRequest request, HttpServletResponse response, ObjectWrapper wrapper, ValueStack stack) {
        ...
        synchronized (servletContext) {
        	 ServletContextHashModel servletContextModel = null;
        	if(servletContext.getAttribute(ATTR_APPLICATION_MODEL) != null && servletContext.getAttribute(ATTR_APPLICATION_MODEL) instanceof ServletContextHashModel){
        		servletContextModel = (ServletContextHashModel) servletContext.getAttribute(ATTR_APPLICATION_MODEL);
        	}
