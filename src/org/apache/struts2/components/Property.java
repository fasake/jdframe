...
public class Property extends Component {
	...
	public boolean start(Writer writer) {
        ...
        Object obj = getStack().findValue(value);
        actualValue = (String) getStack().findValue(value, String.class, throwExceptionOnELFailure);
       if(obj != null && obj instanceof java.util.Date && !StringUtils.isEmptyOrNull(format) ){
    	   actualValue  = DateUtils.format((java.util.Date)getStack().findValue(value), format);
       }
        try {
            if (actualValue != null) {
