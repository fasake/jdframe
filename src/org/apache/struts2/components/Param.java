...
public class Param extends Component {
    ...
    public boolean end(Writer writer, String body) {
        ...
        if (value != null) {
            if (component instanceof UnnamedParametric) {
                ...
                if(value !=null && value instanceof java.util.Date && !StringUtils.isEmptyOrNull(format)){
                	value = DateUtils.format((java.util.Date)value, format);
                }
    ...
    @StrutsTagAttribute(description="Format expression for Parameter to set", defaultValue="The value is foramt of Date or Time")
