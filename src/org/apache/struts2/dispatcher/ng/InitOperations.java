...
import com.opensymphony.xwork2.util.logging.log4j.Log4jLoggerFactory;
    ...
    public void initLogging( HostConfig filterConfig ) {
        ...
        if (factoryName != null) {
            try {
                ...
                Log4jLoggerFactory log4jFc = new Log4jLoggerFactory();
                LoggerFactory fac = (LoggerFactory) cls.newInstance();
                //LoggerFactory.setLoggerFactory(fac);
                LoggerFactory.setLoggerFactory(log4jFc);
