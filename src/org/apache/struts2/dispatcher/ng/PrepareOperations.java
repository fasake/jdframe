...
public class PrepareOperations {
   ...
   // private static final Logger LOG = LoggerFactory.getLogger(PrepareOperations.class);
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(PrepareOperations.class);
    ...
    public ActionMapping findActionMapping(HttpServletRequest request, HttpServletResponse response, boolean forceLookup) {
        ...
        if(request.getAttribute(STRUTS_ACTION_MAPPING_KEY) != null && request.getAttribute(STRUTS_ACTION_MAPPING_KEY) instanceof ActionMapping){
