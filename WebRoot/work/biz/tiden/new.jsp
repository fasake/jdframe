...
<body>
	...
	<s:form action="new" namespace="/work/biz/tiden"  enctype="multipart/form-data" method="post" onsubmit="doprogress()">
			...
			<tr>
				...
				<td width="50%">
					<table class="editGrid">
						<tr height="30">
							<td class="highLightNormal" width="15%" nowrap="nowrap" colspan="4">&nbsp; Input Form:</td>
						</tr>
						<!-- // TODO Auto-generated  -->
						<tr class="repCnd">
							<td class="repCndLb">LINENUMBER:</td>
							<td class="repCndEditRight">
								<s:textfield name="var.linenumber" size="linenumber" size="22" maxlength="22"></s:textfield><font color='red'>&nbsp;*&nbsp;Auto-generated If The Input Is Empty</font>
							</td>
						</tr>
						<tr class="repCnd">
							<td class="repCndLb">TPAYER:</td>
							<td class="repCndEditRight">
								<s:textfield name="var.tpayer" size="tpayer" size="20" maxlength="20"></s:textfield><font color='red'>&nbsp;*&nbsp;Auto-generated If The Input Is Empty</font>
							</td>
						</tr>
						<tr class="repCnd">
