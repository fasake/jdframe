...
<body>
	<div class="topBar">
		<table  height="98%" width="98%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="topTitle">&nbsp;&nbsp;系统管理&gt;&gt;系统岗位管理&gt;&gt;修改系统岗位&gt;&gt;</td>
				<td>
	...
	<s:form action="update" namespace="/com/jdframe/sys/core/station"  onsubmit="doprogress()">
			...
			<tr>
				...
				<td width="50%">
					<table class="editGrid">
						...
						<tr class="repCnd">
							<td class="repCndLb">岗位ID:</td>
							<td class="repCndEditRight">
							    <s:textfield name="var.station_id"  size="30"   readonly="true"></s:textfield><font color="red">&nbsp;&nbsp;(必选性，不可修改)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							<td class="repCndLb">岗位排序:</td>
							<td class="repCndEditRight"><s:textfield
									name="var.station_order" size="80"></s:textfield><font color="red">&nbsp;&nbsp;(可选性)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<s:hidden name="var.station_zzjg_dm"></s:hidden>
						    </td>
						</tr>
						<tr class="repCnd">
							<td class="repCndLb">岗位创建人:</td>
							<td class="repCndEditRight">
							 <c:conversion codeType="DM_CZRY" codeNo="var.station_creater"/>
							</td>
						</tr>
						
						<tr class="repCnd">
							<td class="repCndLb">岗位创建日期:</td>
							<td class="repCndEditRight">
							 <s:property value="var.station_create_date"/>
							</td>
						</tr>
...
<script type="text/javascript">
//初始化菜单树值
var roleids = document.getElementsByName("var.station_role_id")[0].value.split(",");
for(var n=0;n<roleids.length;n++){
	if(document.getElementById("_chk"+roleids[n])){
       document.getElementById("_chk"+roleids[n]).checked = true;	
	}
}
