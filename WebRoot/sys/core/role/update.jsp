...
<body>
	<div class="topBar">
		<table  height="98%" width="98%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="topTitle">&nbsp;&nbsp;系统管理&gt;&gt;系统角色管理&gt;&gt;修改</td>
				<td>
	...
	<s:form action="update" namespace="/com/jdframe/sys/core/role"  onsubmit="doprogress()">
			...
			<tr>
				...
				<td width="50%">
					<table class="editGrid">
						...
						<tr class="repCnd">
							<td class="repCndLb">角色ID:</td>
							<td class="repCndEditRight">
							    <s:textfield name="var.role_id"  size="30"   readonly="true"></s:textfield><font color="red">&nbsp;&nbsp;(必选性，不可修改)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight">
								<s:textfield name="var.role_name" size="80"></s:textfield><font color="red">&nbsp;&nbsp;(必选性)</font>
							 </td>
						</tr>
						...
						<tr class="repCnd">
							<td class="repCndLb">角色排序:</td>
							<td class="repCndEditRight"><s:textfield
									name="var.role_order" size="80"></s:textfield><font color="red">&nbsp;&nbsp;(可选性)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<s:hidden name="var.role_zzjg_dm"></s:hidden>
						    </td>
						</tr>
						<tr class="repCnd">
							<td class="repCndLb">角色创建人:</td>
							<td class="repCndEditRight">
							<c:conversion codeType="DM_CZRY" codeNo="var.role_creater"/>
							</td>
						</tr>
						
						<tr class="repCnd">
							<td class="repCndLb">角色创建日期:</td>
							<td class="repCndEditRight">
							<s:property value="var.role_create_date"/>
							</td>
						</tr>
...
<script type="text/javascript">
//初始化菜单树值
var menuids = document.getElementsByName("var.role_menu_id")[0].value.split(",");
for(var n=0;n<menuids.length;n++){
	if(document.getElementById("_chk"+menuids[n])){
       document.getElementById("_chk"+menuids[n]).checked = true;	
	}
}
function check(){
