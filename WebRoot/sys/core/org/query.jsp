...
<body >
	...
	<div class="topBar">
		<table height="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="topTitle">&nbsp;&nbsp;系统管理&gt;&gt;组织机构管理   
				  &nbsp;&nbsp;<font color="red"> 当前机构:<c:conversion codeType="DM_ZZJG" codeNo="var.zzjg_dm_sj"/>(<s:property value="var.zzjg_dm_sj"/>)</font>
				</td>
			</tr>
		</table>
	</div>
	<s:form   action="query"  namespace="/com/jdframe/sys/core/org"  onsubmit="doprogress()">
					...
					<table class="editGrid">
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight">
								<s:textfield name="var.zzjg_dm" size="20" maxlength="18"></s:textfield><font color="red">&nbsp;&nbsp;(可选性，支持模糊查询)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight">
								<s:textfield name="var.zzjg_name" size="80" maxlength="78"></s:textfield><font color="red">&nbsp;&nbsp;(可选性，支持模糊查询)</font>
							</td>
						</tr>
					                 ...
					                 <s:iterator value="pagenationList"  var="lst">
					                   <tr class="editGrid" type="data">
											<td class="editGrid"  align="right">
												<s:property value="#lst.zzjg_id"/>
											</td>
											<td class="editGrid" align="left">
												<s:property value="#lst.zzjg_dm"/>
											</td>
											<td class="editGrid" align="left">
												<s:property value="#lst.zzjg_name"/>
											</td>
											<td class="editGrid">
											    <c:conversion codeType="DM_ZZJG_BZ" codeNo="#lst.zzjg_bz"/>
												
											</td>
											<td class="editGrid">
											<s:url id="lnk_update" action="update!init"  namespace="/com/jdframe/sys/core/org">
												<s:param name="var.zzjg_dm" value="#lst.zzjg_dm"> </s:param>
											 </s:url>
											 
											 <s:url id="lnk_delete" action="delete"  namespace="/com/jdframe/sys/core/org">
												<s:param name="var.zzjg_dm" value="#lst.zzjg_dm"> </s:param>
											 </s:url>
