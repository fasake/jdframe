...
<body>
	...
	<div class="topBar">
		<table height="98%"  width="98%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="topTitle">&nbsp;&nbsp;系统管理&gt;&gt;组织机构管理&gt;&gt;修改&nbsp;&nbsp;<font color="red"> 当前机构:<c:conversion codeType="DM_ZZJG" codeNo="var.zzjg_dm_sj"/>(<s:property value="var.zzjg_dm_sj"/>)</font></td>
				<td>
					<div style="width:100%;font-size:10pt;padding:0px" align="right">
	...
	<s:form   action="update"  namespace="/com/jdframe/sys/core/org" onsubmit="doprogress()">
			...
			<tr>
				...
				<td>
					...
					<table class="editGrid">
						...
						<tr class="repCnd">
							<td class="repCndLb">机构ID:</td>
							<td class="repCndEditRight">
								<s:textfield name="var.zzjg_id" size="40"  readonly="true"  ></s:textfield><font color="red">&nbsp;&nbsp;(必选性，不可修改)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight">
								<s:textfield name="var.zzjg_dm" size="40"  maxLength="20" readonly="true"></s:textfield><font color="red">&nbsp;&nbsp;(必选性，不可修改)</font>
							 </td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight"><s:textfield
									name="var.zzjg_name" size="80" maxlength="78"></s:textfield><font color="red">&nbsp;&nbsp;(必选性)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight"><s:textfield
									name="var.zzjg_jc"  size="80" maxlength="78"></s:textfield><font color="red">&nbsp;&nbsp;(可选性)</font>
						    </td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight"><s:textfield
									name="var.zzjg_dz"  size="80" maxlength="78"></s:textfield><font color="red">&nbsp;&nbsp;(可选性)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight"><s:textfield
									name="var.zzjg_dh"  size="40" maxlength="38"></s:textfield><font color="red">&nbsp;&nbsp;(可选性)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight"><s:textfield
									name="var.zzjg_coord" size="40" maxlength="38"></s:textfield><font color="red">&nbsp;&nbsp;(可选性)</font>
							</td>
						</tr>
						...
						<tr class="repCnd">
							...
							<td class="repCndEditRight">
									...
									<c:conversion codeType="DM_ZZJG" codeNo="var.zzjg_dm_sj"/><font color="red">&nbsp;&nbsp;(必选性，不可修改)</font>
							</td>
						</tr>
