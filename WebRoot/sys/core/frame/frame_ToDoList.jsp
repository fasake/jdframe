...
<frameset rows="73,*" frameborder="no" border="0" framespacing="0" name="mainframe" onLoad="moveTo(0,0);resizeTo(screen.width,screen.height);">
  ...
  <frameset rows="24,*" frameborder="no" border="0" framespacing="0">
		...
		<frameset cols="228,*" frameborder="NO" border="0" framespacing="0" name="split2">
		<frame src="/sys/core/frame/left_Notice.jsp" name="leftFrame" scrolling="NO" noresize>
		<frameset cols="9,*" frameborder="NO" border="0" framespacing="0">
		  ...
		  <frame src="/com/jdframe/sys/core/task/queryTask!init" name="main" id="main" scrolling="NO" />
		 </frameset>
  </frameset>
